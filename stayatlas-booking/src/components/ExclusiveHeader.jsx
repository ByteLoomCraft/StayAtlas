    ...
    <header className="bg-black sticky top-0 z-50 shadow-md">
      <div className="max-w-[2560px] mx-auto flex justify-between items-center py-5 px-6 md:px-20">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          <a href="/" className="text-white font-semibold text-sm relative hover:after:w-full after:transition-all after:duration-300 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-blue-500 after:w-0">
            HOME
          </a>
          ...
          <a
            ...
            className="text-white font-semibold text-sm relative hover:after:w-full after:transition-all after:duration-300 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-blue-500 after:w-0"
          >
            CONTACT US
          </a>
        </div>
